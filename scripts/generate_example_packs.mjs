...
const EXAMPLES = [
  ...
  e(250, "Partner Meeting Brief", "gog,summarize,notion", "partner history, current goals, and open commercial questions", "a pre-meeting brief with evidence and questions to resolve", "meeting preparation time", "per meeting", "partner contacts and commercial context"),
